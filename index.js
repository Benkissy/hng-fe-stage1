document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelector('[data-testid="currentDay"]').textContent = `Day: ${currentDay}`;
...
function updateUTCTime() {
    ...
    document.querySelector('[data-testid="currentTimeUTC"]').textContent = `UTCTime: ${currentUTCTimeInMillis}`;
}